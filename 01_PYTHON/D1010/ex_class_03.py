...
class Product:
    ...
    def __init__(self, name, price, mdate, amount):
        self.name = name
        self.price = price
        self.mdate = mdate
        self.amount = amount
    ...
    def print_info(self):
        ...
        print(f'제품수량: {self.amount}')
        print('*' * 20)
#__________________________________________________________________________
# 속성과 메서드 활용
#__________________________________________________________________________
# 객체(인스턴스) 생성
tv = Product('TV', 100000, '2025/10/10', 100)
