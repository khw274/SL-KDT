...
class KoreanPeople:
    ...
    def _print_info(self):  # import 시 접근 불가
        print('*' * 25)
        print(f'이   름: {self.name}')
        print(f'나   이: {self.age}')
        print(f'성   별: {self.gender}')
...
# hong.__jumin = '1111'  # 이건 캡슐화가 안됨 -> 없는 속성으로 보고 추가해버림

# 비공개 속성 주민번호 읽기 -> error 발생
# print(hong.__jumin)    # 이건 캡슐화가 되는데
# hong.__jumin = hong.__jumin + "0000"  # 원래 값을 읽어오는 식이면 캡슐화가 됨

# Python은 캡슐화가 완벽하지는 않음
