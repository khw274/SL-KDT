...
b1.pack(side = "top")          ## - [기본] 버튼 위에 text 보여질 만큼 Width, Height 크기로 버튼 배치     
b1.pack(side="top", fill="x")  ## - side = "top"인 경우 가로(x축)공간만 확장 가능함 => fill='x'
