...
# => 정적 메서드 호출________________________________________________________
# => 클래스이름.정적메서드(), 인스턴스이름.정적메서드()
print(C.sm(10))     # x=10
print(c1.sm(10))    # x=10 (여전히 self 안 넘어옴)

# => 클래스 메서드 호출______________________________________________________
