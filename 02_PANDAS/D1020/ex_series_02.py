...
#__________________________________________________________________________
# -> data, index
dataSR1 = pd.Series(jumsu, idx) # 시리즈 생성
print(dataSR1)

# -> data, index, dtype
dataSR2 = pd.Series(jumsu, idx, dtype=pd.Int8Dtype()) # 시리즈 생성
print(dataSR2)

# -> data, index, dtype='int8'
dataSR3 = pd.Series(jumsu, idx, dtype="int8") # 시리즈 생성
print(dataSR3)

# -> data, index, dtype='int8'
dataSR4 = pd.Series(jumsu, idx, dtype="int8", name="jumsu") # 시리즈 생성
print(dataSR4)
